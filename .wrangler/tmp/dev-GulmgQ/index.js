...
// src/server/index.ts
var app = new Hono2();
app.get("/api/dashboard/clients", accessAuth, async (c) => {
  c.json("Soham Dharap's Dashboard");
});
...
// .wrangler/tmp/bundle-pXFIhB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-pXFIhB/middleware-loader.entry.ts
